    ...
    return (
        <section id="hero" className="relative min-h-[100dvh] bg-forest text-cream flex items-center pt-24 overflow-hidden">
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                >
                    <motion.div variants={fadeInUp} className="font-heading text-sm sm:text-base tracking-widest text-lime uppercase">
                    ...
                    <motion.p variants={fadeInUp} className="font-sans text-lg sm:text-xl text-cream/90 max-w-md">
                        Your daily dose of protein starting at just ₹30. No lectures, just good food.
                    </motion.p>

                    <motion.div variants={fadeInUp} className="text-lime font-heading font-medium italic mt-2">
